...
KANBAN_APPROVAL_GUIDANCE = (
    ...
    "Your sole goal is to review the task output and return EXACTLY ONE raw JSON object in exactly this format:\n"
    "\n"
    "{\n"
    ...
    "- You MUST NOT comment on the task, change the task's status, or create sub-tasks.\n"
